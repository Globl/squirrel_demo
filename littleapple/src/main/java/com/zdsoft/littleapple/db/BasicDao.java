package com.zdsoft.littleapple.db;
...
import com.zdsoft.littleapple.db.callback.MapRowMapper;
import com.zdsoft.littleapple.db.callback.MultiRowMapper;
import com.zdsoft.littleapple.db.callback.SingleRowMapper;
import com.zdsoft.littleapple.db.helper.DbUtils;
import com.zdsoft.littleapple.db.helper.SqlUtils;
...
public class BasicDao {
    ...
    public SQLiteDatabase openSQLiteDatabase() {
        return com.zdsoft.littleapple.db.DBHelper.getInstance().getWritableDatabase();
    }
    ...
    public void closeSQLiteDatabase() {
        com.zdsoft.littleapple.db.DBHelper.getInstance().close();
    }
     ...
     *
     * @param table
     * @param nullColumnHack 当values是空时，指向该字段的设置成null，插入。
     * @param values
     * @return
     */
