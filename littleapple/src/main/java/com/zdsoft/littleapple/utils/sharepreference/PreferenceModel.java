 ...
 * $Id: PreferenceModel.java 65429 2016-02-25 03:13:07Z tujh $
 */
package com.zdsoft.littleapple.utils.sharepreference;
...
public class PreferenceModel {
     ...
     *
     * @param key
     * @param defValue 当key对应的值不存在时，返回这个默认值
     * @return
     */
     ...
     *
     * @param key      唯一key值
     * @param defValue 默认值，当key对应的值不存在时，就返回这个默认值
     * @param type     获取的值的类型，详情参看：Types枚举
     * @return
     */
     ...
     * @param key   唯一key值
     * @param value 参数的值
     * @param type  参数值的类型，对应支持的类型参看：Types枚举
     */
